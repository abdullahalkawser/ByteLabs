...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden text-white bg-slate-950 text-slate-100 relative overflow-hidden font-sans selection:bg-purple-500/30e border-t border-gray-900/60 font-sans">
